...
/**
 * CheckSeriesAvailabilityViewHelper
 *
 ...
 */
class CheckSeriesAvailabilityViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper
{
    /**
    ...
    {
        return !(bool)count(Stock::getOutOfStockSeries($publication));
        //===
    }
}